...
public class ProductManagerTest {
    ...
    public void Testing() {
        ...
        List<Product> _productList_bySold = pm.getProductList_bySold();
        assertEquals(_productList_byPrice.get(0).getId(), 001, 001);
        assertEquals(_productList_byPrice.get(1).getId(), 002, 002);
        assertEquals(_productList_byPrice.get(0).getId(), 003, 003);
